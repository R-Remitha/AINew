...
console.log('jsondata:', jsondata);
  ...
  return (
    ...
    <div>
      <ul id="navbar">
        <li><NavLink to="/dashboard"><FaUser></FaUser> Username :{authdata.author_name}</NavLink></li>
      ...
      <p className="lab_discourse">Discourse</p>
        ...
        <div className="ttab2"><input type='file' onChange={handleFileSelect}/></div>
        ...
        <div style={{ display: showIframe ? 'block' : 'none' }}>
          ...
          <div className="usrtop"><iframe className="usr" width="994px" id="usr" height="540" title="usr" src={`/usrtablepath?receivedindex=${receivedIndex}&discoursename=${discourse_name}&receivedItem=${receivedItem}`} /> </div>
        </div>
      </form>
    </>
  )
